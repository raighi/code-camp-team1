...
def create_parser():
    ...
    subparsers = parser.add_subparsers(help='The commands to manage tasks', dest='command', required=True)

    # Create parser for the add command
    parser_add = subparsers.add_parser('add', help='Add a new task. The rest of the command line is used for the task '
