...
def create_parser():
    ...
    parser_modify.add_argument('new_details', type=str, nargs='*',
                               help="the new details", default=["no details"])
    parser_modify.add_argument('-u', '--new_user', nargs='*', required=False,
                               type=str, help='New user associated with the task', default=["None"])
